            ...
            <div class="box-body">
                ...
                <form method="POST" id="formActualizarPerfil"
                    ...
                    <div class="form-group">
                        ...
                        <input name="password" type="password" class="form-control" id="Contrasena">
                    </div>
                    <div class="form-group">
                        <label>Confirmar contraseña</label>
                        <input type="password" class="form-control" id="ConfirmarContrasena">
                        <span class="help-block" id="mensajePasswordNoCoiciden">Contraseñas no coiciden</span>
                    </div>
                    <div class="form-group">
                        <label>Foto</label>
...
<script>
    function doClickActualizar(event){
        if($("#txtContrasena").val() == $("#txtConfirmarContrasena").val()){
            ...
            //Muestro errores
            $("#mensajePasswordNoCoiciden").show();
            $(".grupo")
        }
    }
    ...
    $(function(){
        $('#mensajePasswordNoCoiciden').hide();
